...
medico(04,"", 02,["Santa Maria"]).
medico(05,"", 03,["HES", "IPO"]).
medico(06,"", 07,["Santa Casa da Misericordia", "Sao cruz"]).
medico(07,"", 05,["Senhora da Oliveira", "Sao Cruz"]).
medico(08,"", 08,["Senhora da Oliveira"]).
medico(09,"", 09,["IPO","Santa Maria", "Santa Casa da Misericordia"]).
medico(10,"", 10,["Sao Cruz", "HES"]).
medico(11,"", 04,["Sao Cruz", "Santa Maria"]).
medico(12,"", 06,["Senhora da Oliveira", "Santa Maria"]).
medico(13,"", 03,["HES", "Senhora da Oliveira"]).
medico(14,"", 07,["Santa Casa da Misericordia", "Sao Cruz"]).
medico(15,"", 09,["IPO"]).
