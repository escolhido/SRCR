...
dados$ExhaustionLevel <- as.numeric(discretize(dados$ExhaustionLevel, method = "frequency", categories = 5))#, labels = c(0,0.25,0.5,0.75,1)))

exaustao <- table(dados$ExhaustionLevel)
